...
<script>
	...
	$(document).ready(
			function() {
				...
				$("#update_survey_detalils").click(function(){
					adminObj.UpdateSurveyDates(globalObj.GetSurveyUUID(),$("#start_date").val(),$("#end_date").val());
				});
				
				$('#otherSurveyDetails').on('shown.bs.modal', function(e) {  
					globalObj.GetSurveyDetails(globalObj.GetSurveyUUID(),
					"update_active_surveys");
			    });
			});
