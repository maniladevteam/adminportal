...
global.globalObj.prototype = {
	...
	SetParameterForEmailSending : function(surveyId, surveyName) {
	...
	BuidlQuestionType : function(answerType, value, questionUUID, isRequired,
		...
		element = element
				...
				+ "'><input name='check_me_out_"
				+ counter
				+ "' onclick='globalObj.LinkQuestionToVerbatim(this,\"update_active_surveys\",globalObj.GetSurveyUUID(),globalObj.GetThisQuestionText(\""
