	...
	<div>
		<div>
			<center>
				...
				Operating System: <input type="text" id="os_name_add"
					placeholder="Operating System" value=""
				...
				<div>
					...
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="button"
						value="Add" id="os_add_button" style="width: 110px;" />
				</div>
			</center>
		</div>
	</div>
