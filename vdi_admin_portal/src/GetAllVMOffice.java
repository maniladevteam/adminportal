...
/**
 * Servlet implementation class GetAllVMOffice
 */
@WebServlet("/GetAllVMOffice")
public class GetAllVMOffice extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    Connection con = null;
    public GetAllVMOffice() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			try {
				...
				CallableStatement cs = con.prepareCall("EXEC spGetAllOffice");
