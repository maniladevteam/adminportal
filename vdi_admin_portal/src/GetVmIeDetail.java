...
/**
 * Servlet implementation class GetVmIeDetail
 */
@WebServlet("/GetVmIeDetail")
public class GetVmIeDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	Connection con = null;
	public GetVmIeDetail() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spGetDetailIe] '" + ieId  + "'");
