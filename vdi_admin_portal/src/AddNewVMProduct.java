...
/**
 * Servlet implementation class AddNewVMProduct
 */
@WebServlet("/AddNewVMProduct")
public class AddNewVMProduct extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddNewVMProduct() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		HttpServletResponse response) throws ServletException, IOException {try {
			...
			CallableStatement cs = con.prepareCall("EXEC [AddNewProduct] '" + productName.replace("*****","&")   + "', '" + region + "'"
					);
