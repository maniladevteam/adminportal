...
/**
 * Servlet implementation class GetAllEMEAVmWares
 */
@WebServlet("/GetAllEMEAVmWares")
public class GetAllEMEAVmWares extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetAllEMEAVmWares() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spGetVMEMEA]");
