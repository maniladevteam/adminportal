...
/**
 * Servlet implementation class DeleteIeFromList
 */
@WebServlet("/DeleteIeFromList")
public class DeleteIeFromList extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DeleteIeFromList() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spDeleteIe] '" + ieId +"'");
