...
/**
 * Servlet implementation class GetVMProductDetail
 */
@WebServlet("/GetVMProductDetail")
public class GetVMProductDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetVMProductDetail() {
		super();
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {try {
				...
				CallableStatement cs = con.prepareCall("EXEC [GetProductDetail] '" + productId  + "', '" + region + "'");
