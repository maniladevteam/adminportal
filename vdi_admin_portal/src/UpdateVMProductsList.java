...
/**
 * Servlet implementation class UpdateVMProductsList
 */
@WebServlet("/UpdateVMProductsList")
public class UpdateVMProductsList extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateVMProductsList() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		HttpServletResponse response) throws ServletException, IOException {try {
			...
			con = null;
			  ...
			  String region = (jsonObj.getString("region") == null) ? "" :jsonObj.getString("region");
			  String productId = (jsonObj.getString("productId") == null) ? "" :jsonObj.getString("productId");
			  String productName = (jsonObj.getString("productName") == null) ? "" :jsonObj.getString("productName");
			  String productVersion = (jsonObj.getString("productVersion") == null) ? "" :jsonObj.getString("productVersion");
			...
			CallableStatement cs = con.prepareCall("EXEC [UpdateProduct] '" + productName.replace("*****","&")  + "','" + productVersion +"', '" + region + "','"
					+ productId + "'"
					);
