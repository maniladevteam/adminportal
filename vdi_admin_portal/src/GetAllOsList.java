...
/**
 * Servlet implementation class GetAllOsList
 */
@WebServlet("/GetAllOsList")
public class GetAllOsList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
				try {
					...
					CallableStatement cs = con.prepareCall("EXEC [spGetAllOperatingSystem]");
