...
/**
 * Servlet implementation class AddVMOffice
 */
@WebServlet("/AddVMOffice")
public class AddVMOffice extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spAddOffice] '" + officeName  + "'");
