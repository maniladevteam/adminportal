...
/**
 * Servlet implementation class GetAllVMProducts
 */
@WebServlet("/GetAllVMProducts")
public class GetAllVMProducts extends HttpServlet {
	private static final long serialVersionUID = 1L;

	Connection con = null;
	public GetAllVMProducts() {
		super();
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {try {
				...
				con = null;
				  ...
				  String vmref = (jsonObj.getString("vmref") == null) ? "" :jsonObj.getString("vmref");
				...
				CallableStatement cs = con.prepareCall("EXEC GetAllVmProducts '" + vmref + "'" +", '" + region + "'");
