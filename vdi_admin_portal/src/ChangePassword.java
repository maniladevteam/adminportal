...
public class ChangePassword extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String email = (jsonObj.getString("email") == null) ? "" : jsonObj
					.getString("email");
			
			String password = (jsonObj.getString("password") == null) ? "" : jsonObj
					.getString("password");
			...
			CallableStatement cs = con.prepareCall("EXEC [ChangePassword] " + "'" + userId + "',"
					+ "'" + password + "'" + ",'" +  email +"'");
