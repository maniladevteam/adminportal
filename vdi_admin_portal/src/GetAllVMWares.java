...
/**
 * Servlet implementation class GetAllVMWares
 */
@WebServlet("/GetAllVMWares")
public class GetAllVMWares extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
			...
			try {
				...
				CallableStatement cs = con.prepareCall("EXEC spGetVMAmers");
