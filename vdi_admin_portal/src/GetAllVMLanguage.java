...
/**
 * Servlet implementation class GetAllVMLanguage
 */
@WebServlet("/GetAllVMLanguage")
public class GetAllVMLanguage extends HttpServlet {
	private static final long serialVersionUID = 1L;

	Connection con = null;

	public GetAllVMLanguage() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			 ...
			 * JSONObject jsonObj = new JSONObject(jsonParameters); String
			 * scores = (jsonObj.getString("scores") == null) ? "" :
			 * jsonObj.getString("scores");
			 */
			...
			CallableStatement cs = con.prepareCall("EXEC spGetAllLanguage");
