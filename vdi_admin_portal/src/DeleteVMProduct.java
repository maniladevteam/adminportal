...
/**
 * Servlet implementation class DeleteVMProduct
 */
@WebServlet("/DeleteVMProduct")
public class DeleteVMProduct extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DeleteVMProduct() {
		super();
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {try {
				...
				CallableStatement cs = con.prepareCall("EXEC [DeleteProduct] '" + productId  + "', '" + region + "'"
						);
