...
/**
 * Servlet implementation class GetAllUnselectedVmProd
 */
@WebServlet("/GetAllUnselectedVmProd")
public class GetAllUnselectedVmProd extends HttpServlet {
	private static final long serialVersionUID = 1L;

	
	Connection con = null;
	
	public GetAllUnselectedVmProd() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC GetPerVmNonSelectedProducts '"
					+ vmref + "'" + ", '" + region + "'");
