...
/**
 * Servlet implementation class GetVMLanguageDetail
 */
@WebServlet("/GetVMLanguageDetail")
public class GetVMLanguageDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetVMLanguageDetail() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spGetDetailLanguage] '"
					+ langId + "'");
