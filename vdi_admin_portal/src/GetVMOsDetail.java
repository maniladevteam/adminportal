...
/**
 * Servlet implementation class GetVMOsDetail
 */
@WebServlet("/GetVMOsDetail")
public class GetVMOsDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetVMOsDetail() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String osId = (jsonObj.getString("osId") == null) ? ""
					: jsonObj.getString("osId");
			...
			CallableStatement cs = con.prepareCall("EXEC [spGetDetailOperatingSystem] '" + osId  + "'");
