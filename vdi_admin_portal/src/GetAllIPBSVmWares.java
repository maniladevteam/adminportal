...
/**
 * Servlet implementation class GetAllIPBSVmWares
 */
@WebServlet("/GetAllIPBSVmWares")
public class GetAllIPBSVmWares extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetAllIPBSVmWares() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spGetVMIPBS]");
