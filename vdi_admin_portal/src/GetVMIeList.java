...
/**
 * Servlet implementation class GetVMIeList
 */
@WebServlet("/GetVMIeList")
public class GetVMIeList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		HttpServletResponse response) throws ServletException, IOException {
			try {
				...
				CallableStatement cs = con.prepareCall("EXEC GetAllIeList");
