...
/**
 * Servlet implementation class DeleteVMOffice
 */
@WebServlet("/DeleteVMOffice")
public class DeleteVMOffice extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DeleteVMOffice() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spDeleteOffice] '" + officeId +"'");
