...
/**
 * Servlet implementation class DisableVMWare
 */
@WebServlet("/DisableVMWare")
public class DisableVMWare extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DisableVMWare() {
		super();
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {try {
				...
				CallableStatement cs = con.prepareCall("EXEC [spDisableVM] '" + vmref  + "', '" + region + "','0'"
						);
