...
/**
 * Servlet implementation class GetIPBSVMDetail
 */
@WebServlet("/GetIPBSVMDetail")
public class GetIPBSVMDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetIPBSVMDetail() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spGetVmIPBSDetail] '"
					+ vmref + "'");
