...
/**
 * Servlet implementation class DeleteVMLanguage
 */
@WebServlet("/DeleteVMLanguage")
public class DeleteVMLanguage extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DeleteVMLanguage() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spDeleteLanguage] '" + langId + "'");
