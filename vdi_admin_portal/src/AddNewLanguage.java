...
/**
 * Servlet implementation class AddNewLanguage
 */
@WebServlet("/AddNewLanguage")
public class AddNewLanguage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spAddLanguage] '" + langName + "'");
