...
/**
 * Servlet implementation class GetEMEAVMDetail
 */
@WebServlet("/GetEMEAVMDetail")
public class GetEMEAVMDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetEMEAVMDetail() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spGetVmEMEADetail] '"
					+ vmref + "'");
