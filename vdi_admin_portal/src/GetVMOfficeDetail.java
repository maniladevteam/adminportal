...
/**
 * Servlet implementation class GetVMOfficeDetail
 */
@WebServlet("/GetVMOfficeDetail")
public class GetVMOfficeDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetVMOfficeDetail() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spGetDetailOffice] '" + officeId  + "'");
