...
/**
 * Servlet implementation class AddNewIPBSVM
 */
@WebServlet("/AddNewIPBSVM")
public class AddNewIPBSVM extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spAddIPBSVirtualMachine] "
					+ "'" + vmref + "'" 
					+ ", ' ','" 
					+ ieId 
					+ "','" + enabled +"'"
