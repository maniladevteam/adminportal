...
/**
 * Servlet implementation class DeleteVMCreateUpdate
 */
@WebServlet("/DeleteVMCreateUpdate")
public class DeleteVMCreateUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;

	Connection con = null;
	public DeleteVMCreateUpdate() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC DeleteVmWare '"
					+ vmref + "'" + ", '" + region + "'");
