...
/**
 * Servlet implementation class UpdateVMLanguage
 */
@WebServlet("/UpdateVMLanguage")
public class UpdateVMLanguage extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateVMLanguage() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String langId = (jsonObj.getString("langId") == null) ? ""
					: jsonObj.getString("langId");
			String langName = (jsonObj.getString("langName") == null) ? ""
					: jsonObj.getString("langName");
			...
			CallableStatement cs = con.prepareCall("EXEC [spUpdateLanguage] '"
					+ langId + "', '" + langName + "'");
