...
/**
 * Servlet implementation class GetAPACVMDetail
 */
@WebServlet("/GetAPACVMDetail")
public class GetAPACVMDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;


	public GetAPACVMDetail() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC spGetVmAPACDetail '" + vmref + "'");
