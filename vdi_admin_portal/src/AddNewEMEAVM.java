...
/**
 * Servlet implementation class AddNewEMEAVM
 */
@WebServlet("/AddNewEMEAVM")
public class AddNewEMEAVM extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC [spAddEMEAVirtualMachine] "
					+ "'" + vmref + "'" 
					+ ", ' ','" 
					+ ieId 
					+ "','" + enabled +"'"
