...
/**
 * Servlet implementation class UpdateIE
 */
@WebServlet("/UpdateIE")
public class UpdateIE extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String ieId = (jsonObj.getString("ieId") == null) ? ""
					: jsonObj.getString("ieId");
			String ieName = (jsonObj.getString("ieName") == null) ? ""
					: jsonObj.getString("ieName");
			...
			CallableStatement cs = con.prepareCall("EXEC [spUpdateInternetExplorer] '" + ieId +"', '" + ieName + "'");
