...
/**
 * Servlet implementation class GetAllAPACVmWares
 */
@WebServlet("/GetAllAPACVmWares")
public class GetAllAPACVmWares extends HttpServlet {
	private static final long serialVersionUID = 1L;

	
	public GetAllAPACVmWares() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC spGetVMApac");
