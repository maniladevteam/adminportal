...
/**
 * Servlet implementation class GetVMDetail
 */
@WebServlet("/GetVMDetail")
public class GetVMDetail extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			CallableStatement cs = con.prepareCall("EXEC spGetVmAMERSDetail \""
					+ vmref + "\"");
