...
/**
 * Servlet implementation class UpdateVMOffice
 */
@WebServlet("/UpdateVMOffice")
public class UpdateVMOffice extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateVMOffice() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String officeId = (jsonObj.getString("officeId") == null) ? ""
					: jsonObj.getString("officeId");
			String officeName = (jsonObj.getString("officeName") == null) ? ""
					: jsonObj.getString("officeName");
			...
			CallableStatement cs = con.prepareCall("EXEC [spUpdateOffice] '"
					+ officeId + "', '" + officeName + "'");
