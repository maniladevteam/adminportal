...
/**
 * Servlet implementation class GetAllProductsPerRegion
 */
@WebServlet("/GetAllProductsPerRegion")
public class GetAllProductsPerRegion extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetAllProductsPerRegion() {
		super();
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {try {
				...
				CallableStatement cs = con.prepareCall("EXEC [GetAllProducts] '" + region + "'");
