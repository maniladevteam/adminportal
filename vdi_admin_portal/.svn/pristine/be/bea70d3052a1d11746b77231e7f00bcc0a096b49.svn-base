...
<body>
	...
	<div>
		<div>
			<center>
				Internet Explorer Version:<input type="text" id="ie_name_add"
							placeholder="Internet Explorer version" value=""
				...
				<div>
					...
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="button"
						value="Add" id="ie_add_button" style="width: 110px;" />
				</div>
			</center>
		</div>
	</div>
